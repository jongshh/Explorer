...
**Explore!** 는 OpenAI의 **GPT-4o**와 **DALL-E 3**를 활용한 웹 기반 텍스트 어드벤처 게임(TRPG)입니다.
...
해당 프로젝트는 Rimworld 를 오마주하여 제작하였습니다.

## ✨ 핵심 기능 (Key Features)

### 1\. ♾️ 무한한 자유도와 스토리텔링

  * **GPT-4o Mini / GPT-4o** 기반의 실시간 서사 생성. (모델은 추후 확장할 예정)
...
## 알려진 버그
  ...
  * 동료들의 상태창이 변경, 증발하는 문제 (데이터 최적화 로직 오류)
  * 플레이어 주도적인 대화 진행
  * 비용 증발 속도(...)
